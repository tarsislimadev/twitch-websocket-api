import { HTML, nFlex, nButton } from './libs/afrontend/index.js'
import { InputTextGroup } from './elements/input.text.group.js'
import { TitleComponent } from './components/title.js'
import { MessageComponent } from './components/message.js'
import { MessageModel } from './models/message.js'

export class Page extends HTML {
  nick = new InputTextGroup()
  channel = new InputTextGroup()
  message = new InputTextGroup()
  messages = new HTML()
  ...
  getButtonsFlex() {
    ...
    flex.append(this.getSendJoinMessageButton())
    flex.append(this.getSendUserMessageButton())
    return flex
  }
  ...
  getSendJoinMessageButton() {
    return this.createSendMessageButton('send join', () => `JOIN #${this.channel.input.getValue()}`)
  }

  getSendUserMessageButton() {
    return this.createSendMessageButton('send', () => `PRIVMSG #${this.channel.input.getValue()} :${this.message.input.getValue()}`)
  }
